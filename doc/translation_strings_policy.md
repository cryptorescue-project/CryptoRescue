...
This document provides guidelines for internationalization of the CryptoRescue Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `cryptorescue_en.ts` remains unchanged.
