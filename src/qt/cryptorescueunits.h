...
#ifndef CRYPTORESCUE_QT_CRYPTORESCUEUNITS_H
#define CRYPTORESCUE_QT_CRYPTORESCUEUNITS_H
...
/** CryptoRescue unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class CryptoRescueUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit CryptoRescueUnits(QObject *parent);

    /** CryptoRescue units.
      @note Source: https://en.cryptorescue.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CPR,
...
typedef CryptoRescueUnits::Unit CryptoRescueUnit;

#endif // CRYPTORESCUE_QT_CRYPTORESCUEUNITS_H
