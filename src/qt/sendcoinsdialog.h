...
#ifndef CRYPTORESCUE_QT_SENDCOINSDIALOG_H
#define CRYPTORESCUE_QT_SENDCOINSDIALOG_H
...
/** Dialog for sending cryptorescues */
...
#endif // CRYPTORESCUE_QT_SENDCOINSDIALOG_H
