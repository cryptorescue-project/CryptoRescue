...
#include "qt/cryptorescueamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<CryptoRescueAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_cryptorescue-qt -platform xcb      # Linux
//     src/qt/test/test_cryptorescue-qt -platform windows  # Windows
//     src/qt/test/test_cryptorescue-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = CryptoRescueUnits::formatWithUnit(unit, balance, false, CryptoRescueUnits::separatorAlways);
    ...
    // Amount input
    CryptoRescueAmountField* amountInput = receiveCoinsDialog.findChild<CryptoRescueAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: cryptorescue:")) != -1);
