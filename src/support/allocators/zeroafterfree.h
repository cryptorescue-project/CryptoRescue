...
#ifndef CRYPTORESCUE_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define CRYPTORESCUE_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // CRYPTORESCUE_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
