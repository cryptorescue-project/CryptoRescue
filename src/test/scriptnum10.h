...
#ifndef CRYPTORESCUE_TEST_SCRIPTNUM10_H
#define CRYPTORESCUE_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from CryptoRescue Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // CRYPTORESCUE_TEST_BIGNUM_H
