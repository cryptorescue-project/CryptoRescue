...
#ifndef CRYPTORESCUE_WALLET_WALLET_H
#define CRYPTORESCUE_WALLET_WALLET_H
...
public:
     ...
     * on this cryptorescue node, and set to 0 for transactions that were created
...
#endif // CRYPTORESCUE_WALLET_WALLET_H
