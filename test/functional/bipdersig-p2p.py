...
class BIP66Test(CryptoRescueTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # cryptorescued is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and cryptorescued produces more specific reject
            # reasons.
