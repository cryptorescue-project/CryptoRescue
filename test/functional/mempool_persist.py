...
By default, cryptorescued will dump mempool on shutdown and
...
class MempoolPersistTest(CryptoRescueTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give cryptorescued a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent cryptorescued from writing mempool.dat to disk. Verify that `savemempool` fails")
