...
# TestNode: A peer we use to send messages to cryptorescued, and store responses.
...
class CompactBlocksTest(CryptoRescueTestFramework):
    ...
    # This test actually causes cryptorescued to (reasonably!) disconnect us, so do this last.
    ...
    # cryptorescued's choice of nonce.
    ...
    # Test that cryptorescued requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for cryptorescued to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # cryptorescued will not send blocktxn responses for blocks whose height is
