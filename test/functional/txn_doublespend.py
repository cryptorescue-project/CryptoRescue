...
class TxnMallTest(CryptoRescueTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 CPR:
        ...
        # First: use raw transaction API to send 1240 CPR to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 CPR coin each
        ...
        # Node0's balance should be starting balance, plus 50CPR for another
        ...
        # Node0's total balance should be starting balance, plus 100CPR for 
